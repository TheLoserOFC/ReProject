...
const { GZencrypt, AESencrypt, AESdecrypt } = require('./Utils/Encrypts/Encrypts');
const Encrypts = require('./Utils/Encrypts/Encrypts');
...
app.get('/teste', (req, res) => {
    let chave = "123";
    let hashing = bcrypt.hashSync(chave)
    var json = {
       senha: chave,
       Hash: hashing,
       a: bcrypt.compareSync(chave, hashing),
       b: bcrypt.compareSync("1234", hashing),
